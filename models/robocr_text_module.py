...
class RoboTextEmbeddingDataset(Dataset):
    """
    ...
    It loads pre-computed 768-dimensional text embeddings from MatsciBERT
...
class RoboTextFeatureExtractor(nn.Module):
    """
    ...
    """
    def __init__(self, input_dim: int = 768, output_dim: int = 64, dropout=0.1):
        """
        Args:
            input_dim (int): Dimension of the input text embedding vector. 
                           Defaults to 768 for MatSci-BERT embeddings.
